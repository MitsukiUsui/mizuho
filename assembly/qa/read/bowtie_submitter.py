...
def main(listFilepath):
    ...
    for assemname in list_df[0]:
        ...
        outDirec="/work/GoryaninU/mitsuki/out/bowtie/mizuho"
        samFilepath="{}/{}.sam".format(outDirec, assemname)
        insertFilepath="{}/{}.insert".format(outDirec, assemname)
        cmd="sbatch bowtie.sh {} {} {} {} {} {}".format(scaffFilepath, dbFilepath, fl, fr, samFilepath, insertFilepath)
        myrun(cmd)
